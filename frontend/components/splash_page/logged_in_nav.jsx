        ...
        <nav className="logged-in-nav">
            <div className="buttons-container">
                ...
                <div className="navbar-icons-logged-in">
                    ...
                    <div className="left-navbar-icons-container" onClick={handleNotifications}>
                    ...
                    <div className="left-navbar-icons-container" onClick={handleLists}>
                    ...
                    <div className="left-navbar-icons-container" onClick={handleStories}>
                    ...
                    <div className="left-navbar-icons-container" onClick={handleWrite}>
