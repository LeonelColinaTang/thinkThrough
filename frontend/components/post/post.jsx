...
import { deleteOnePost } from "../../actions/post_actions";
import { useHistory } from "react-router-dom";
import Comments from "./comments";
import { addLike, unLike } from "../../actions/like_actions";
                ...
                <div className="post-buttons">
                    <div className="post-like-comments">
                        <div className="post-likes-button" onClick={e=>handleLikes(post.id)}>
                            ...
                            {/* Why doesnt it work when I use post.likes <--- associations only work on the backend */}
                          
                            <p>{likes.length}</p>
                        </div>
                        <div className="post-comments-button" onClick={handleComments}>
                            <svg width="24" height="24" viewBox="0 0 24 24" aria-label="responses" className="kl">
                    ...
                    <div className="post-save-delete">
                        <div className="post-save">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="px">
                        ...
                        <div className="post-delete">
                            ...
                            {postOptions && user === post.user_id && <div className="post-options">
